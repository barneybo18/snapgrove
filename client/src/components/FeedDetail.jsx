  ...
  return (
    <div className='w-screen h-auto flex flex-col items-center justify-center relative'>
      <div className='w-full h-[240px]  relative'>
        <img src={NewPostBg} className='w-full h-full object-cover' alt="Banner" />
      ...
      <div className='w-full grid grid-cols-1 lg:grid-cols-2 px-8 lg:px-12 xl:px-32 py-6 gap-4'>
        ...
        <div className="flex items-start flex-col justify-start w-full gap-6">
          ...
          <div className="flex items-center justify-center gap-3">
            ...
            <div
              className={`w-8 h-8 rounded-md flex items-center justify-center border cursor-pointer  ${alreadySaved
                  ? "border-emerald-400"
          ...
          {feed?.keywords?.length > 0 && (
            <p className='text-base text-primary font-semibold'>
              Tags : {feed?.keywords?.map((tag, i) => (
                <span className='px-1 py-[1px] mx-1 rounded-md border border-gray-200 ' key={i}>
                  {tag}
                </span>
              ))}
            </p>
          ...
          <div className='w-full items-center justify-center flex-wrap gap-3'>
            <MasonaryLayout
              ...
              feeds={feed?.otherMedia
                ? feeds?.slice(0, 12).filter(item => item.otherMedia)
      ...
      <div className='w-full px-32 xl:px-32 flex flex-col items-start justify-start'>
